### Implementations of CLIP losses from open_clip repository
...
from .base import BaseImageLoss, BaseCaptionLoss, BaseImageCaptionLoss
...
class ClipLoss(BaseImageCaptionLoss):
...
class SigLipLoss(BaseImageCaptionLoss):
