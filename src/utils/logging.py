...
def set_logger(log_file: str, level: str, verbose: bool = False, rank: int = 0, train: bool = True) -> None:
    ...
    Args:
        ...
        train (bool, optional): If True, the logger will save the log file in the output directory. Defaults to True.
